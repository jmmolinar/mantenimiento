...
let ordersTypeJSON = 'http://192.168.1.114:8000/static/js/data/ordersType.JSON';
...
//Estados
let stateJSON = 'http://192.168.1.114:8000/static/js/data/state.JSON';
...
//Activos
let activosJSON = 'http://192.168.1.114:8000/static/js/data/assets.JSON';
...
//Marcas de BlackGPS
let marcasJSON = 'http://192.168.1.114:8000/static/js/data/brand.JSON';
let titleMarcasJSON = 'Marcas BLACKGPS';
let getMarcas = [];
getMarcas = getJson(marcasJSON, titleMarcasJSON);

//Modelos de BlackGPS
let modelosJSON = 'http://192.168.1.114:8000/static/js/data/model.JSON';
...
//Bodegas
let bodegasJSON = 'http://192.168.1.114:8000/static/js/data/assetsWareHouses.JSON';
let titleBodegasJSON = 'Bodegas';
let getBodegas = [];
getBodegas = getJson(bodegasJSON, titleBodegasJSON);

//Categorías de servicio
let categoriasJSON = 'http://192.168.1.114:8000/static/js/data/serviceCategories.JSON';
let titleCategoriasJSON = 'Categorías';
let getCategorias = [];
getCategorias = getJson(categoriasJSON, titleCategoriasJSON);

//Planes de mantenimiento
let planesJSON = 'http://192.168.1.114:8000/static/js/data/planning.JSON';
let titlePlanesJSON = 'Planes';
let getPlanes = [];
getPlanes = getJson(planesJSON, titlePlanesJSON);

//Regiones
/*let regionesJSON = 'http://192.168.1.114:8000/static/js/data/regions.JSON';
